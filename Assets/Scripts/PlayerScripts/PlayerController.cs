...
{
    //�ndrad fr�n tutorialen, bored bara ha saker med movement och animation f�r movement.
    ...
    {
        // hopp
        if (jumpBufferTimer > 0f && coyoteTimer > 0f) // nya systemet �r l�ngt
        {
            ...
            coyoteTimer = 0f; // kunde n�stan dubbelhoppa
            jumpBufferTimer = 0f;
        }
        
    }
    private void CalcJumpBuffer() // calc �r f�rlorkning till calculate, kalkylera p� svenska
    {
